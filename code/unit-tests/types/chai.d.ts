// *** ROOT COMMENT *** //
// This file has been adapted from the type declaration file available from npm at @types/chai
// to provide relevant types to the unit testing code in the global scope
...
// Added by Root to make methods available as global scope functions

declare function expect(val: any, message?: string): Assertion;
