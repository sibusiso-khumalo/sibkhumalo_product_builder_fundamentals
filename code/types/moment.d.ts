// *** ROOT COMMENT *** //
// This file has been adapted from the type declaration file provided with the moment library from npm
// to provide relevant types to the product module code in the global scope
